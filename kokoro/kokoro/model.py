...
class KModel(torch.nn.Module):
    ...
    def __init__(
        ...
        duration_encoder_adapters: Optional[torch.nn.ModuleList] = None,
        decoder_adapters: Optional[torch.nn.ModuleList] = None,
        generator_adapters: Optional[torch.nn.ModuleList] = None,
    ):
        super().__init__()
        if repo_id is None:
        ...
        self.predictor = ProsodyPredictor(
            ...
            duration_encoder_adapters=duration_encoder_adapters,
        )
        ...
        self.decoder = Decoder(
            ...
            generator_adapters=generator_adapters,
            **config['istftnet']
        )
        if not model:
